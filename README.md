...
This is a local setup of DeepSeek-OCR for Windows environments, including virtual environments and sample scripts.
...
1. Clone the repository:
   ```bash
   git clone https://github.com/yourusername/Deepseek-Ocr-Cpu.git
   cd Deepseek-Ocr-Cpu
   ```
...
### Usage
1. Run the CPU inference script:
   ```bash
   python run_cpu.py
   ```
2. For testing with sample image:
   Place your image in the root and modify the script accordingly.

### Output
Results will be saved in the `output/` directory, including processed images, text files, and logs.

For more details on the original DeepSeek-OCR, refer to the sections above.
